...
public class Item
{
    ...
    public static Item axeObsidian = (new ItemAxe(706, EnumToolMaterial.OBSIDIAN)).setIconCoord(1, 12).setItemName("hatchetObsidian");
    public static Item hoeObsidian = (new ItemHoe(707, EnumToolMaterial.OBSIDIAN)).setIconCoord(1, 13).setItemName("hoeObsidian");
    public static Item helmetObsidian = (new ItemArmor(708, EnumArmorMaterial.OBSIDIAN, 5, 0)).setIconCoord(2, 10).setItemName("helmetObsidian");
    public static Item plateObsidian = (new ItemArmor(709, EnumArmorMaterial.OBSIDIAN, 5, 1)).setIconCoord(2, 11).setItemName("chestplateObsidian");
	public static Item legsObsidian = (new ItemArmor(710, EnumArmorMaterial.OBSIDIAN, 5, 2)).setIconCoord(2, 12).setItemName("leggingsObsidian");
	public static Item bootsObsidian = (new ItemArmor(711, EnumArmorMaterial.OBSIDIAN, 5, 3)).setIconCoord(2, 13).setItemName("bootsObsidian");
	public static Item swordEmerald = (new ItemSword(712, EnumToolMaterial.EMERALD)).setIconCoord(3, 9).setItemName("swordEmerald");
	public static Item shovelEmerald = (new ItemSpade(713, EnumToolMaterial.EMERALD)).setIconCoord(3, 10).setItemName("shovelEmerald");
	public static Item pickaxeEmerald = (new ItemPickaxe(714, EnumToolMaterial.EMERALD)).setIconCoord(3, 11).setItemName("pickaxeEmerald");
	public static Item axeEmerald = (new ItemAxe(715, EnumToolMaterial.EMERALD)).setIconCoord(3, 12).setItemName("hatchetEmerald");
	public static Item hoeEmerald = (new ItemHoe(716, EnumToolMaterial.EMERALD)).setIconCoord(3, 13).setItemName("hoeEmerald");
	public static Item helmetEmerald = (new ItemArmor(717, EnumArmorMaterial.EMERALD, 6, 0)).setIconCoord(4, 10).setItemName("helmetEmerald");
	public static Item plateEmerald = (new ItemArmor(718, EnumArmorMaterial.EMERALD, 6, 1)).setIconCoord(4, 11).setItemName("chestplateEmerald");
	public static Item legsEmerald = (new ItemArmor(719, EnumArmorMaterial.EMERALD, 6, 2)).setIconCoord(4, 12).setItemName("leggingsEmerald");
	public static Item bootsEmerald = (new ItemArmor(720, EnumArmorMaterial.EMERALD, 6, 3)).setIconCoord(4, 13).setItemName("bootsEmerald");
    public static Item ruby = (new Item(721)).setIconCoord(10, 10).setItemName("ruby").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item swordRuby = (new ItemSword(722, EnumToolMaterial.RUBY)).setIconCoord(5, 9).setItemName("swordRuby");
	public static Item shovelRuby = (new ItemSpade(723, EnumToolMaterial.RUBY)).setIconCoord(5, 10).setItemName("shovelRuby");
	public static Item pickaxeRuby = (new ItemPickaxe(724, EnumToolMaterial.RUBY)).setIconCoord(5, 11).setItemName("pickaxeRuby");
	public static Item axeRuby = (new ItemAxe(725, EnumToolMaterial.RUBY)).setIconCoord(5, 12).setItemName("hatchetRuby");
	public static Item hoeRuby = (new ItemHoe(726, EnumToolMaterial.RUBY)).setIconCoord(5, 13).setItemName("hoeRuby");
	public static Item helmetRuby = (new ItemArmor(727, EnumArmorMaterial.RUBY, 7, 0)).setIconCoord(6, 10).setItemName("helmetRuby");
	public static Item plateRuby = (new ItemArmor(728, EnumArmorMaterial.RUBY, 7, 1)).setIconCoord(6, 11).setItemName("chestplateRuby");
	public static Item legsRuby = (new ItemArmor(729, EnumArmorMaterial.RUBY, 7, 2)).setIconCoord(6, 12).setItemName("leggingsRuby");
	public static Item bootsRuby = (new ItemArmor(730, EnumArmorMaterial.RUBY, 7, 3)).setIconCoord(6, 13).setItemName("bootsRuby");

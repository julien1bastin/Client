...
import fr.nukkit.renders.RenderBank;
import fr.nukkit.renders.RenderChair;
import fr.nukkit.renders.RenderTable;
...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        // Nukkit start - adding new renders
        RenderChair chair = new RenderChair(this);
        RenderTable table = new RenderTable(this);
        RenderBank bank = new RenderBank(this);
        
        if(var5 == 70)
        	return chair.render(par1Block, par2, par3, par4);
        if(var5 == 71)
        	return table.render(par1Block, par2, par3, par4);
        if(var5 == 72)
        	return bank.render(par1Block, par2, par3, par4);
        // Nukkit end
    ...
    public void renderBlockAsItem(Block par1Block, int par2, float par3)
    {
        ...
        if (var6 != 0 && var6 != 31 && var6 != 16 && var6 != 26)
        {
            ...
            // Nukkit start - adding renders
            RenderChair chair = new RenderChair(this);
            RenderTable table = new RenderTable(this);
            RenderBank bank = new RenderBank(this);
            
            if (var6 == 70)
            	chair.render(var4, par1Block);
            else if (var6 == 71)
            	table.render(var4, par1Block);
            else if (var6 == 72)
            	bank.render(var4, par1Block);
    ...
    {
    	// Nukkit start - adding 3D render in hand
    	if(par0 == 70 || par0 == 71 || par0 == 72)
    		return true;
    	// Nukkit end
